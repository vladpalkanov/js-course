...
Веб-приложения: фронтенд и бекенд, мобильные и десктопные приложения, игры, блокчейн и нейронные сети, и даже ПО для микроконтроллеров - все это можно разрабатывать на JavaScript.

# История и мотивация создания.

```
Данный текст - это краткий пересказ  https://habr.com/company/livetyping/blog/324196/
```
...
И осознав, что сил HTML и CSS для этого не хватает, а хватает у них _денег_, решили придумать язык программирования.
